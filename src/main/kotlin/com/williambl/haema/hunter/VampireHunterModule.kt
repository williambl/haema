...
object VampireHunterModule: ModInitializer {
    ...
    override fun onInitialize() {
        ...
        FabricStructureBuilder.create(Identifier("haema:vampire_hunter_outpost"), VAMPIRE_HUNTER_OUTPOST_FEATURE)
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, Identifier("haema:configured_vampire_hunter_outpost"), CONFIGURED_VAMPIRE_HUNTER_OUTPOST_FEATURE)
        ...
        FabricStructureBuilder.create(Identifier("haema:small_vampire_hunter_outpost"), SMALL_VAMPIRE_HUNTER_OUTPOST_FEATURE)
            .step(GenerationStep.Feature.SURFACE_STRUCTURES)
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, Identifier("haema:configured_small_vampire_hunter_outpost"), CONFIGURED_SMALL_VAMPIRE_HUNTER_OUTPOST_FEATURE)
