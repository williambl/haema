...
public class VampireHunterRenderer extends MobRenderer<VampireHunter, VampireHunterRenderer.VampireHunterModel> {
    private static ResourceLocation TEXTURE = id("textures/entity/vampire_hunter.png");

    public VampireHunterRenderer(EntityRendererProvider.Context context) {
        super(context, new VampireHunterModel(context.bakeLayer(VampireHunterModel.LAYER)), 0.5f);
        this.addLayer(new CustomHeadLayer<>(this, context.getModelSet(), context.getItemInHandRenderer()));
        this.addLayer(new ItemInHandLayer<>(this, context.getItemInHandRenderer()));
    }

    @Override
    protected void scale(VampireHunter livingEntity, PoseStack poseStack, float f) {
    ...
    static class VampireHunterModel extends HierarchicalModel<VampireHunter> implements ArmedModel, HeadedModel {
        public static final ModelLayerLocation LAYER = new ModelLayerLocation(id("vampire_hunter"), "main");
        ...
        VampireHunterModel(ModelPart root) {
            this.root = root;
        ...
        @Override
        public void setupAnim(VampireHunter entity, float f, float g, float h, float i, float j) {
            ...
            if (entity.isHolding(Items.CROSSBOW)) {
                if (entity.isCharging()) {
                    AnimationUtils.animateCrossbowCharge(this.rightAttackingArm, this.leftAttackingArm, entity, true);
                } else {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            var modelPartData3 = modelPartData.addOrReplaceChild(
                    PartNames.ARMS,
